...
<head>
  ...
  <title>Junrejo - Berita Details</title>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="layanan"><span>Layanan</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li><a href="/layanan/suratkettidakmampu">Surat Keterangan Usaha</a></li>
              <li><a href="/layanan/surat-ket-usaha">Surat Keterangan Tidak Mampu</a></li>
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-8">
            ...
            <article class="blog-details">
              ...
              <div class="meta-top">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="/berita/berita-details">John Doe</a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="/berita/berita-details"><time datetime="2020-01-01">Jan 1, 2022</time></a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a href="/berita/berita-details">12 Comments</a></li>
                </ul>
              </div><!-- End meta top -->
              ...
              <div class="sidebar-item recent-posts">
                ...
                <div class="mt-3">
                  ...
                  <div class="post-item mt-3">
                    ...
                    <div>
                      <h4><a href="/berita/berita-details">Nihil blanditiis at in nihil autem</a></h4>
                  ...
                  <div class="post-item">
                    ...
                    <div>
                      <h4><a href="/berita/berita-details">Quidem autem et impedit</a></h4>
                      <time datetime="2020-01-01">Jan 1, 2020</time>
                    </div>
                  </div><!-- End recent post item-->
                  ...
                  <div class="post-item">
                    ...
                    <div>
                      <h4><a href="/berita/berita-details">Id quia et et ut maxime similique occaecati ut</a></h4>
                      <time datetime="2020-01-01">Jan 1, 2020</time>
                    </div>
                  </div><!-- End recent post item-->
                  ...
                  <div class="post-item">
                    ...
                    <div>
                      <h4><a href="/berita/berita-details">Laborum corporis quo dara net para</a></h4>
                      <time datetime="2020-01-01">Jan 1, 2020</time>
                    </div>
                  </div><!-- End recent post item-->
                  ...
                  <div class="post-item">
                    ...
                    <div>
                      <h4><a href="/berita/berita-details">Et dolores corrupti quae illo quod dolor</a></h4>
                      <time datetime="2020-01-01">Jan 1, 2020</time>
                    </div>
                  </div><!-- End recent post item-->
